    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            renderTarget = new RenderTarget2D(GraphicsDevice, GraphicsDevice.Viewport.Width,
                GraphicsDevice.Viewport.Height, 1, GraphicsDevice.DisplayMode.Format,
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (state)
            {
                case TransitionState.CrossFade:
                    {
                        ...
                        spriteBatch.Draw(renderTarget.GetTexture(), Vector2.Zero,
                ...
                case TransitionState.Wipe:
                    {
                        ...
                        spriteBatch.Draw(sceneTexture, wipeOutDestinationRectangle, wipeOutSourceRectangle, Color.White);
                ...
                default:
                    {
                        spriteBatch.Draw(sceneTexture, Vector2.Zero,
                        Color.White);
                        break;
                    }
            }
