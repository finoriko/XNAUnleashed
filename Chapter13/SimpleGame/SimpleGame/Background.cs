...
namespace SimpleGame
{
    ...
    public class Background : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        {
#if ZUNE
            //flipped flopped on purpose. Wanting to do landscape
            int viewportWidth = GraphicsDevice.Viewport.Height;
            int viewportHeight = GraphicsDevice.Viewport.Width;

            int textureWidth = 512;
            int cloudHeight = 256;
            int cityHeight = 128;
            int foregroundHeight = 64;
            int streetHeight = 64;
            int cloudY = 0;
        ...
        {
#if ZUNE
            spriteBatch.End(); //Don't bother rendering clouds in additive mode
