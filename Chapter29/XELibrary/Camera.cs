...
namespace XELibrary
{
    ...
    public class Camera : Microsoft.Xna.Framework.GameComponent
    {
        ...
        private void InitializeCamera()
        {
            ...
            //View
            Matrix.CreateLookAt(ref Position, ref cameraTarget,
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (targetSet)
            {
                Matrix.CreateLookAt(ref Position, ref cameraTarget, ref cameraUpVector,
                    out view);
            ...
            Vector3.Add(ref Position, ref transformedReference, out cameraTarget);
