...
{
    public class Concentration : Microsoft.Xna.Framework.Game
    {
        ...
        {
            //For release, do not add any extra latency or packet loss! ;-)
            NetworkSession.SimulatedLatency = TimeSpan.Zero;
            NetworkSession.SimulatedPacketLoss = 0.0f;

            //But for testing on System Link to simulate LIVE conditions do
            ...
            //For "I wish I was dead" traffic
            //NetworkSession.SimulatedLatency = TimeSpan.FromMilliseconds(2000);
            //NetworkSession.SimulatedPacketLoss = .8f;
        }
    }
}
