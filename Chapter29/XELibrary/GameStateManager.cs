...
namespace XELibrary
{
    public class GameStateManager : GameComponent, IGameStateManager
    {
        ...
        public void PushState(GameState newState, PlayerIndex? playerIndexInControl)
        {
            drawOrder += 100;
            newState.DrawOrder = drawOrder;

            AddState(newState, playerIndexInControl);
        ...
        private void AddState(GameState state, PlayerIndex? playerIndexInControl)
        {
            state.PlayerIndexInControl = playerIndexInControl;
            states.Push(state);
        ...
        public void ChangeState(GameState newState, PlayerIndex? playerIndexInControl)
        {
