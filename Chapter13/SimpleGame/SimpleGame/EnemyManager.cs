...
namespace SimpleGame
{
    ...
    {
#if ZUNE
        private readonly int maxXPosition = 400;
        private readonly int minXPosition = 325;
        private readonly float collisionDistance = 32.0f;
        private int yPosition = 175;
        private int xPosition = 325; //275
#else
